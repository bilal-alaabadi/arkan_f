...
const Navbar = () => {
  ...
  return (
    <header className="w-full bg-gray-950 shadow-sm relative z-50 pt-10 text-white">
      <div className="mx-auto px-4">
        ...
        <div className="md:hidden flex items-center justify-between h-16 mb-2 pb-12 pt-4">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <Link to="/">
              <img src={log} alt="شعار المتجر" className="h-24 object-contain" />
            </Link>
          </div>
                    ...
                    <ul className="py-2">
                      {dropdownMenus.map((menu, index) => (
                        <li key={index}>
                          <Link
                            ...
                            className="block px-4 py-3 text-lg text-white hover:bg-gray-700 transition-colors"
                          >
                            {menu.label}
                          </Link>
                        </li>
                      ...
                      <li>
                        <button
                          ...
                          className="block w-full text-right px-4 py-3 text-lg text-white hover:bg-gray-700 transition-colors"
                        >
                          تسجيل الخروج
                        </button>
                      </li>
      ...
      >
        <div
          className={`absolute bottom-0 left-0 right-0 bg-gray-900 rounded-t-3xl shadow-xl transition-transform duration-300 ${
            isMobileMenuOpen ? 'translate-y-0' : 'translate-y-full'
          }`}
        >
          <div className="px-6 py-6 flex flex-col items-center gap-4 text-white">
            <button
              onClick={handleMobileMenuToggle}
